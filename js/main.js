  ...
  async function populateReleaseTable() {
    ...
    try {
      ...
      releases.forEach((release) => {
        ...
        const listenHtml = release.listenLink
          ? `<a href="${release.listenLink}" target="_blank"><font>Listen</font></a>`
          : "";
        const buyHtml = release.buyLink
          ? `<a href="${release.buyLink}" target="_blank"><font>Buy</font></a>`
          : "";
        const moreHtml = release.moreLink
          ? `<a href="${release.moreLink}" target="_blank"><font>More</font></a>`
          : "";
